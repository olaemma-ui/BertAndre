    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <main className="relative -top-21">
                ...
                <section className="py-20 lg:py-28 pt-20">
                    <div className="container mx-auto px-6 max-w-4xl">
                        <div className="prose prose-lg flex-col gap-4 max-w-none font-sans">
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold ">1. Introduction</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">2. Intellectual Property</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">3. Services</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">4. Limitation of Liability</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">5. Governing Law</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">6. Changes to Terms</h3>
                                <p>
                            ...
                            <div className="space-y-2 mb-3">
                                <h3 className="text-xl md:text-2xl font-bold">7. Contact Us</h3>
                                <p>
