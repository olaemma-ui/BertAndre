        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              <div className="bg-[#1560bd]/5 md:col-span-2 gap-4 flex items-start md:items-center p-6 rounded-3xl transition-all">
                <div className="w-12 h-12 shrink-0 bg-white rounded-full flex items-center justify-center text-[#1560bd]">
              ...
              <div className="bg-[#1560bd]/5 flex gap-4 items-start md:items-center p-6 rounded-3xl transition-all">
                <div className="w-12 h-12 shrink-0 bg-white rounded-full flex items-center justify-center text-[#1560bd]">
              ...
              <div className="bg-[#1560bd]/5 flex gap-4 items-center p-6 rounded-3xl transition-all">
                <div className="w-12 h-12 shrink-0 bg-white rounded-full flex items-center justify-center text-[#1560bd]">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#1a1a1a]">Email Us</h3>
                  <p className="text-gray-600 break-all">{settings.contact_email}</p>
                </div>
              </div>
            </div>
          </motion.div>
